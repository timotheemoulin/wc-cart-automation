...
Automate cart creation for Woocommerce. Allows to generate cart with voucher code and preselected products.

== Description ==

This plugin adds a way to automate the cart creation process.

Configure a special link that you can put in your promotional email to automatically add
products to the visitor's cart.
